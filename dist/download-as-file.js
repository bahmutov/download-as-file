(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["downloadAsFile"] = factory();
	else
		root["downloadAsFile"] = factory();
})(window, function() {
...
function downloadAsFile(opts) {
  ...
  var uri = opts.type === 'text/plain' ? 'data:text/plain;charset=utf-8,' + encodeURIComponent(opts.data) : 'data:' + opts.type + 'base64,' + window.btoa(unescape(encodeURIComponent(opts.data)));
